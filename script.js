$(document).ready(function() {
    ...
    $(".search-input").keyup(function() {
        ...
        $.getJSON("https://www.omdbapi.com/?", { apikey: "d97b7b8a", s: search }, function(data) {
            if (data.Search !== undefined) {
                $.each(data.Search, function(index, value) {
                    if (index < 2) {
                        $.getJSON("https://www.omdbapi.com/?", { apikey: "d97b7b8a", i: value.imdbID }, function(movieData) {
                            if (movieData) {
    ...
    $("#show-more").click(function(e) {
        ...
        $.getJSON("https://www.omdbapi.com/?", { apikey: "d97b7b8a", s: search }, function(listData) {
            if (/Mobi|Android/i.test(navigator.userAgent)) {
            ...
            if (listData.Search !== undefined) {
                $.each(listData.Search, function(index, value) {
                    $.getJSON("https://www.omdbapi.com/?", { apikey: "d97b7b8a", i: value.imdbID }, function(listMovieData) {
                        if (listMovieData) {
